        ...
        <main>
            ...
            <section class="attributes">
                ...
                <div class="saves list-section box">
                    <ul>
                    <li>
                        <label for="Strength-save">Strength</label><input class="Strength sw" name="Strength-save" placeholder="+0" type="text" /><input name="Strength-save-prof" class="Strength prof-check" type="checkbox" />
                    </li>
                    <li>
                        <label for="Dexterity-save">Dexterity</label><input class="Dexterity sw" name="Dexterity-save" placeholder="+0" type="text" /><input name="Dexterity-save-prof" class="Dexterity prof-check" type="checkbox" />
                    </li>
                    <li>
                        <label for="Constitution-save">Constitution</label><input class="Constitution sw" name="Constitution-save" placeholder="+0" type="text" /><input name="Constitution-save-prof" class="Constitution prof-check" type="checkbox" />
                    </li>
                    <li>
                        <label for="Intelligence-save">Intelligence</label><input class="Intelligence sw" name="Intelligence-save" placeholder="+0" type="text" /><input name="Intelligence-save-prof" class="Intelligence prof-check" type="checkbox" />
                    </li>
                    <li>
                        <label for="Wisdom-save">Wisdom</label><input class="Wisdom sw" name="Wisdom-save" placeholder="+0" type="text" /><input name="Wisdom-save-prof" class="Wisdom prof-check" type="checkbox" />
                    </li>
                    <li>
                        <label for="Charisma-save">Charisma</label><input class="Charisma sw" name="Charisma-save" placeholder="+0" type="text" /><input name="Charisma-save-prof" class="Charisma prof-check" type="checkbox" />
                    </li>
                    </ul>
                    <div class="label">
                    Saving Throws
                ...
                <div class="skills list-section box">
                    <ul>
                    <li>
                        <label for="Acrobatics">Acrobatics <span class="skill">(Dex)</span></label><input class="Dexterity skill-input" name="Acrobatics" placeholder="+0" type="text" /><input name="Acrobatics-prof" class="Dexterity prof-check" type="checkbox" />
                    </li>
                    <li>
                        <label for="Animal Handling">Animal Handling <span class="skill">(Wis)</span></label><input class="Wisdom skill-input" name="Animal Handling" placeholder="+0" type="text" /><input name="Animal Handling-prof" class="Wisdom prof-check" type="checkbox" />
                    </li>
                    <li>
                        <label for="Arcana">Arcana <span class="skill">(Int)</span></label><input class="Intelligence skill-input" name="Arcana" placeholder="+0" type="text" /><input name="Arcana-prof" class="Intelligence prof-check" type="checkbox" />
                    </li>
                    <li>
                        <label for="Athletics">Athletics <span class="skill">(Str)</span></label><input class="Strength skill-input" name="Athletics" placeholder="+0" type="text" /><input name="Athletics-prof" class="Strength prof-check" type="checkbox" />
                    </li>
                    <li>
                        <label for="Deception">Deception <span class="skill">(Cha)</span></label><input class="Charisma skill-input" name="Deception" placeholder="+0" type="text" /><input name="Deception-prof" class="Charisma prof-check" type="checkbox" />
                    </li>
                    <li>
                        <label for="History">History <span class="skill">(Int)</span></label><input class="Intelligence skill-input" name="History" placeholder="+0" type="text" /><input name="History-prof" class="Intelligence prof-check" type="checkbox" />
                    </li>
                    <li>
                        <label for="Insight">Insight <span class="skill">(Wis)</span></label><input class="Wisdom skill-input" name="Insight" placeholder="+0" type="text" /><input name="Insight-prof" class="Wisdom prof-check" type="checkbox" />
                    </li>
                    <li>
                        <label for="Intimidation">Intimidation <span class="skill">(Cha)</span></label><input class="Charisma skill-input" name="Intimidation" placeholder="+0" type="text" /><input name="Intimidation-prof" class="Charisma prof-check" type="checkbox" />
                    </li>
                    <li>
                        <label for="Investigation">Investigation <span class="skill">(Int)</span></label><input class="Intelligence skill-input" name="Investigation" placeholder="+0" type="text" /><input name="Investigation-prof" class="Intelligence prof-check" type="checkbox" />
                    </li>
                    <li>
                        <label for="Medicine">Medicine <span class="skill">(Wis)</span></label><input class="Wisdom skill-input" name="Medicine" placeholder="+0" type="text" /><input name="Medicine-prof" class="Wisdom prof-check" type="checkbox" />
                    </li>
                    <li>
                        <label for="Nature">Nature <span class="skill">(Int)</span></label><input class="Intelligence skill-input" name="Nature" placeholder="+0" type="text" /><input name="Nature-prof" class="Intelligence prof-check" type="checkbox" />
                    </li>
                    <li>
                        <label for="Perception">Perception <span class="skill">(Wis)</span></label><input class="Wisdom skill-input" name="Perception" placeholder="+0" type="text" /><input name="Perception-prof" class="Wisdom prof-check" type="checkbox" />
                    </li>
                    <li>
                        <label for="Performance">Performance <span class="skill">(Cha)</span></label><input class="Charisma skill-input" name="Performance" placeholder="+0" type="text" /><input name="Performance-prof" class="Charisma prof-check" type="checkbox" />
                    </li>
                    <li>
                        <label for="Persuasion">Persuasion <span class="skill">(Cha)</span></label><input class="Charisma skill-input" name="Persuasion" placeholder="+0" type="text" /><input name="Persuasion-prof" class="Charisma prof-check" type="checkbox" />
                    </li>
                    <li>
                        <label for="Religion">Religion <span class="skill">(Int)</span></label><input class="Intelligence skill-input" name="Religion" placeholder="+0" type="text" /><input name="Religion-prof" class="Intelligence prof-check" type="checkbox" />
                    </li>
                    <li>
                        <label for="Sleight of Hand">Sleight of Hand <span class="skill">(Dex)</span></label><input class="Dexterity skill-input" name="Sleight of Hand" placeholder="+0" type="text" /><input name="Sleight of Hand-prof" class="Dexterity prof-check" type="checkbox" />
                    </li>
                    <li>
                        <label for="Stealth">Stealth <span class="skill">(Dex)</span></label><input class="Dexterity skill-input" name="Stealth" placeholder="+0" type="text" /><input name="Stealth-prof" class="Dexterity prof-check" type="checkbox" />
                    </li>
                    <li>
                        <label for="Survival">Survival <span class="skill">(Wis)</span></label><input class="Wisdom skill-input" name="Survival" placeholder="+0" type="text" /><input name="Survival-prof" class="Wisdom prof-check" type="checkbox" />
                    </li>
                    </ul>
                    <div class="label">
                    Skills
